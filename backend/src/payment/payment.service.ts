  ...
  async confirmOrder(dto: CreateOrderDto) {
    try {
      ...
      const payload = {
        ...
        order_date: new Date().toISOString().slice(0, 10) || '2025-08-11 11:11',
        pickup_location: 'Jammu',
        comment: 'Reseller: M/s Goku',
        billing_customer_name: `${address.name}` || 'ABC',
        billing_last_name: `${address.lastName}` || 'XYZ',
        billing_address: address.address1 || 'House 221B, Leaf Village',
        billing_address_2: 'Near Hokage House',
        billing_city: address.city || 'New Delhi',
        billing_pincode: address.postalCode || 110002,
        billing_state: address.state || 'Delhi',
        billing_country: address.country || 'India',
        billing_email: address.email || 'naruto@uzumaki.com',
        billing_phone: address.phone || 9876543210,
        shipping_is_billing: true,
        shipping_customer_name: 'Tech',
        shipping_last_name: 'Tapestry',
        shipping_address: 'Shagun 808',
        shipping_address_2: 'Ulwe',
        shipping_city: 'Navi Mumbai',
        shipping_pincode: 410206,
        shipping_country: 'India',
        shipping_state: 'Maharastra',
        shipping_email: 'stallion@gmail.com',
